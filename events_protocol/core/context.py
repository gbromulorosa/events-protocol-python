...
class EventContextHolder:
    ...
    @contextmanager
    def with_context(
        cls, context_id: IdType, context_flow_id: IdType, event_name: str, event_version:int, user_id: str = None 
    ):
        try:
            event_context = EventContext(
                id=context_id, flow_id=context_flow_id, event_name=event_name, user_id=user_id, event_version=event_version
            )
